 ...
 */
package store.scriptbenio.util.openauth.microsoft;

import store.scriptbenio.util.openauth.microsoft.model.request.MinecraftLoginRequest;
import store.scriptbenio.util.openauth.microsoft.model.request.XSTSAuthorizationProperties;
import store.scriptbenio.util.openauth.microsoft.model.request.XboxLiveLoginProperties;
import store.scriptbenio.util.openauth.microsoft.model.request.XboxLoginRequest;
import store.scriptbenio.util.openauth.microsoft.model.response.*;
